...
class WonController extends Controller
{
    public function index()
    {
        ...
        //return response()->json(compact('data'));
          return view ('won.index',compact('data'));
    }
    public function edit($idu)
    {
        ...
        return view ('won.editwon',['notes'=>$notes,'todo_desc'=>$todo_desc,'todo_type'=>$todo_type]);
    ...
    {    
        ...
        return redirect() ->route ('won.index');
    }
    ...
    public function show()
    {
        ...
        $todo_desc = \App\todo_desc::all();
        $todo_type = \App\todo_type::all();
        $contact = \App\contact::All()->where('Status', '=', 3);
        $users = \App\users::All();

        // memanggil view tambah
        return view('won.tambahnotes',['users'=>$users,'contact'=>$contact,'todo_type'=>$todo_type,'todo_desc'=>$todo_desc,'notes'=>$notes]);
       // return response()->json([$notes,$todo_desc,$todo_type]);
